					...
					<div class="m-login__contanier">
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" method="post" enctype="multipart/form-data">
		                        ...
		                        @if(isset($successMsg))
		                        <div class="form-group m-form__group">
		                           <p style="text-align: center;"><span class="m--font-success">{{$successMsg}}</span></p>
		                        </div>
		                        <div class="m-login__form-action">
		                           <a href="{{url('/login')}}" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn m-login__btn--danger">Login In</a>
		                        </div>
		                        @else
		                        <div class="form-group m-form__group">
		                        ...
		                        <div class="m-login__form-action">
		                           <button id="m_login_signin_submit" class="btn m-btn--pill m-btn--air btn-danger">Register</button>
...
<!-- 		<script src="{{asset('resources/theme/metronic/vendors/jstree/dist/jstree.js')}}" type="text/javascript"></script>
		...
		<script type="text/javascript">
			$('#username-input').keyboard({type:'numpad'});
		</script>
