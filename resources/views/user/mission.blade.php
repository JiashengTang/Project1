              ...
              <table class="table table-striped table-bordered table-hover table-checkable" id="mission-table">
                 ...
                 <tbody>
                    ...
                    <tr>
                       ...
                       <td nowrap>
                          <a href="{{url('/missions/detail/' . $mission->id)}}" class="btn m-btn--pill    btn-outline-primary" title="View">
                          <i class="la la-trash">Detail</i>
                          </a>
                          <a href="{{url('/missions/delete/' . $mission->id)}}" class="btn m-btn--pill    btn-outline-danger delete-mission" title="View" style="left: 30%">
              ...
              <table class="table table-striped table-bordered table-hover table-checkable" id="history-table">
                 ...
                 <tbody>
                    ...
                    <tr>
                       ...
                       <td nowrap>
                          <a href="{{url('/missions/reactive/' . $history->id)}}" class="btn m-btn--pill    btn-outline-info reactive-mission" title="View">
